...
> **★最重要の原則（§16.1 / §20-risk5）:** **ML は「提案」だけ。最終判断と適合性は必ず
...
設計書 §16.1 / §16.3 / §20-risk5。**ML 提案を無検証で使わせない構造**をここで保証する。
...
通った案だけを採用候補にする（無検証採用は事故・法的責任の元、§20-risk5/6）。
