...
| [0008](0008-secondary-member-load-cascade.md) | superseded by ADR-0015 | 二次部材の荷重は支持相手へ逐次伝達し、交点は常にピンとする |
...
| [0015](0015-explicit-gravity-supports.md) | accepted | 壁自重の支持辺と鉛直二次部材の端部負担率を明示する |
| [0016](0016-material-wall-section-and-directional-strength.md) | accepted | 壁の材料別実断面と正負別せん断耐力を採用する |
