...
トラス機構とアーチ機構の累加により、RC 部材の終局せん断耐力を算定します。
日本建築学会『靭性保証型耐震設計指針』（終局強度型設計指針、藤井・森田式系）に基づきます。
...
付着割裂で耐力が決まる場合の Qbu を算定します。
靭性保証型指針 P.175-181 に基づきます。
...
トラス項とアーチ項からせん断信頼強度 Vu を算定します。
日本建築学会『鉄筋コンクリート造建物の靭性保証型耐震設計指針・同解説』(1997) 式(6.4.1)〜(6.4.11)、付着(6.8.14)〜(6.8.16) に基づきます。
...
柱の軸終局耐力と、等価応力度ブロック法による曲げ終局モーメントを算定します。
軸終局 Nuc/Nut は技術基準解説書、曲げ Mu は ACI318-95 に基づきます。
...
ACI 曲げは、終局ひずみ \\( \varepsilon_{cu} = 0.003 \\) と応力ブロック β1 のもとで中立軸 c を二分法により軸力整合させ、次式で求めます。
