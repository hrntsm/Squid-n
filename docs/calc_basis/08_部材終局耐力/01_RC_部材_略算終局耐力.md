...
**実装**：`squid_n_core::rc_capacity::rc_mu_simple`。
...
**実装**：`squid_n_core::rc_capacity::rc_qmu_simple`。
...
**実装**：`squid_n_core::rc_capacity::rc_column_mu_simple`。
...
**実装**：`squid_n_core::rc_capacity::rc_qsu_simple`。係数は 0.068/0.23/+18/+0.12/0.85/0.1。
...
**実装**：`squid_n_core::rc_capacity::rc_alpha_y_sugano`。
