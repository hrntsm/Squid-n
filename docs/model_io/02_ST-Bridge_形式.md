...
> 床領域の付け直しでは、どの区画にも載らない版、所属の付かない小梁、
> 面積が区画と合わなかった旧床領域の件数も警告します。
